...
const NavBar = () => {
  ...
  return (
    <nav
      style={{ background: "#F2D5F8" }}
      className="flex items-center justify-between flex-wrap bg-purple-400 py-4 lg:px-12 shadow border-solid border-t-2 border-blue-700"
    >
